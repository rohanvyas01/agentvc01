    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <section className="relative overflow-hidden py-32 lg:py-40">
        ...
        <div className="relative max-w-7xl mx-auto container-padding">
          ...
          >
            <motion.h1 
              className="text-display mb-8 text-white text-center"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              ...
              className="text-subtitle mb-12 max-w-3xl mx-auto text-white text-center"
            >
            ...
            {/* Additional content to extend the hero section */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="text-center">
                ...
                <div className="text-white">Pitch Decks Analyzed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-400 mb-2">3x</div>
                <div className="text-white">Faster Capital Raising</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-cyan-400 mb-2">24/7</div>
                <div className="text-white">AI Investor Available</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
