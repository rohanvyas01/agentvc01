/*
  # Database Schema Setup for AgentVC
  ...
  1. New Tables
    - `profiles`
      ...
      - `one_liner_pitch` (text, required)
      - `industry` (text, required)
      - `business_model` (text, required)
      - `funding_round` (text, required)
      - `raise_amount` (text, required)
      - `use_of_funds` (text, required)
  ...
  3. Functions
    ...
    - `create_user_profile` - Profile creation after auth user exists
